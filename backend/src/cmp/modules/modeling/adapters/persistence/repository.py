...
material_model_revision_table = sa.Table(
    ...
    sa.Column("voce_calibration_plan_id", sa.Uuid(), nullable=True),
    sa.Column("voce_calibration_plan_revision_id", sa.Uuid(), nullable=True),
    sa.Column("voce_calibration_run_id", sa.Uuid(), nullable=True),
    sa.Column("voce_calibration_candidate_id", sa.Uuid(), nullable=True),
    sa.Column("voce_calibration_candidate_sha256", sa.CHAR(64), nullable=True),
    sa.Column("voce_candidate_selection_id", sa.Uuid(), nullable=True),
    sa.Column("voce_candidate_selection_revision_id", sa.Uuid(), nullable=True),

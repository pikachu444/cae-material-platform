...
const ids = Array.from({ length: 18 }, (_, index) =>
...
describe("ReferenceOgdenCalibrationWorkbench", () => {
  it("pins governed curves, executes candidates, and displays uncertainty and residuals", async () => {
    ...
    render(<ReferenceOgdenCalibrationWorkbench config={{ baseUrl: "/api/v1", accessToken: "token" }} state={state} model={model} />);
    ...
    expect(screen.getByText(/no holdout data/)).toBeTruthy();

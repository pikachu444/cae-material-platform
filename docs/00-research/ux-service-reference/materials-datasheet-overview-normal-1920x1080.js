(() => {
  ...
  navigatorDivider.setAttribute(
    "aria-valuenow",
    String(Math.round(navigatorPane.getBoundingClientRect().width)),
  );
  window.MaterialsResponseGrid?.render();
  window.MaterialsResponseGrid?.sync();
})();

...
| Saved Recipe library 및 batch | versioned recipe를 저장·수정·재사용하고 선택한 Dataset에 preflight 후 batch 실행한다. | `implemented` | Recipe/Batch engine implemented | lifecycle/preflight/execute/retry | graph-adjacent Recipe/Batch inspector with authoring, preflight, monitor and retry | domain/API/PostgreSQL/Vitest/live browser | `FR-BAT-001~007`, `T-54/T-69/T-70/T-80` |
| 금속 탄소성 modeling | E/proof/necking/true-plastic/four-family fitting/combination/extrapolation을 같은 persistent graph와 material context에서 실행한다. 최종 reviewed Neutral/Card 단계는 T-81이 정리한다. | `partial` | engine evidence retained | methods/promotion/export retained | integrated Metal track and exact Material/State panel | numeric/backend/Vitest/live browser | `FR-MOD-M-001~007`, `T-55M/T-70/T-80/T-81` |
| 폴리머 점탄성 modeling | log-time/Prony/WLF/Arrhenius engine과 Processing Output→generalized-Maxwell IR을 같은 family track에 연결했다. 최종 reviewed delivery는 T-81 범위다. | `partial` | engine evidence retained | fitting/promotion/export retained | integrated Polymer track, Prony graph, IR/Neutral preflight panel | numeric/backend/Vitest/live browser | `FR-MOD-P-001~005`, `T-55P/T-67~T-69/T-80/T-81` |
| 엘라스토머 초탄성/초점탄성 modeling | exact multi-mode/holdout Dataset, saved Plan, four-family fitting, eight-candidate diagnostics, stability/uncertainty와 Prony/card panel을 같은 track에서 실행한다. 최종 reviewed delivery는 T-81 범위다. | `partial` | engine evidence retained | Plan/fitting/promotion/export retained | integrated Elastomer track with live saved-Plan Run and residual plot | numeric/backend/Vitest/live browser | `FR-MOD-E-001~004`, `T-55E/T-72/T-80/T-81` |
...
| 사용자 매뉴얼과 GUI evidence | 자동 demo session, 계층 Material Database, Layout Datasheet/search/compare와 세 family Modeling journey를 실제 화면으로 문서화했다. home-to-card acceptance와 전체 hierarchy는 아직 남아 있다. | `partial` | hierarchy/schema seed retained | verifier retained | current Dashboard/Database/Datasheet/three-family Modeling captures | T-75~T-80 browser evidence, full journey pending | `FR-UX-001~009`, `T-60/T-65/T-75~T-80/T-82/T-83` |

...
| Common Processing Workbench | crop, scale/shift, resample, smoothing, curve alignment/statistics를 ordered method pipeline으로 구성하고 단계별 overlay와 scalar result를 본다. | `partial` | exact input/profile/Output engine | preview/commit methods | T-85 compact shell, semantic curve rail, axes/units/ticks/crosshair, zoom/pan/reset/visibility verified; range/marker and method-direct manipulation pending | numeric/API/Vitest/live Docker/browser + T-85 screenshot | `FR-PRO-001~010`, `T-53/T-79/T-85/T-86` |

...
| Common Processing Workbench | crop, scale/shift, resample, smoothing, curve alignment/statistics를 ordered method pipeline으로 구성하고 단계별 overlay와 scalar result를 본다. | `partial` | exact input/profile/Output engine | preview/commit methods | T-85 compact shell, semantic curve rail, axes/units/ticks/crosshair, zoom/pan/reset/visibility, ephemeral range/point command and cancellable 300 ms preview verified; method-direct T-86 controls pending | numeric/API/Vitest/live Docker/browser + T-85 screenshot | `FR-PRO-001~010`, `T-53/T-79/T-85/T-86` |

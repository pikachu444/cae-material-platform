...
| Common Processing Workbench | crop, scale/shift, resample, smoothing, curve alignment/statistics를 ordered method pipeline으로 구성하고 단계별 overlay와 scalar result를 본다. | `partial` | exact input/profile/Output engine | preview/commit methods | T-85 shell/session accepted: semantic rail, persistent graph, exact Datasheet/Test/recent-session restore, range/point command and cancellable preview. T-86 adds guided E/proof/necking/workup/hardening controls; smoothing/statistics and draggable markers remain | numeric/API/Vitest/live Docker/browser + T-85 screenshot | `FR-PRO-001~010`, `T-53/T-79/T-85/T-86` |
...
| 금속 탄소성 modeling | E/proof/necking/true-plastic/four-family fitting/combination/extrapolation을 같은 persistent graph와 material context에서 실행하고 reviewed Neutral/Card로 전달한다. | `partial` | engine evidence retained | methods/promotion/export retained | calculations connected; Modeler-level direct controls are missing | numeric/backend/Vitest/live browser | `FR-MOD-M-001~007`, `T-55M/T-70/T-80/T-81/T-86~T-88` |
...
| Neutral Material JSON | `cmp.neutral-material`은 metal, linear-viscoelastic, hyperelastic/hyper-viscoelastic selected model을 같은 versioned envelope로 교환한다. | `partial` | typed three-family engine implemented | promotion/validate/import/download implemented | interim delivery controls exist; in-workbench acceptance is pending | schema/domain/API/migration/numeric/Vitest/live browser | `FR-JSON-007~009`, `T-56/T-63/T-64/T-81/T-88~T-90` |
| Solver mapping과 native card | 공식 solver 문서 기반 manifest, six-state preflight, ASCII/sidecar를 제공한다. | `partial` | typed export engine implemented | exact-Neutral preflight/report/card implemented | interim preview/download exists; cohesive Card task is pending | golden/domain/API/migration/UI/live browser | `T-57/T-64/T-81/T-88~T-90` |

...
| 금속 탄소성 modeling | E/proof/necking/true-plastic/four-family fitting/combination/extrapolation을 같은 persistent graph와 material context에서 실행하고 reviewed Neutral/Card로 전달한다. | `partial` | engine evidence retained | methods/promotion/export retained | T-86 Prepare와 T-87 response/residual/tangent/parameter/bounds/blend/bounded-extrapolation GUI accepted; same-surface reviewed delivery remains T-88 | numeric/backend/Vitest/live Docker/browser/screenshots | `FR-MOD-M-001~007`, `T-55M/T-70/T-80/T-81/T-86~T-88` |

...
| 사용자 매뉴얼과 GUI evidence | 자동 demo session, 제품 Dashboard와 T-76 계층 Material Database는 실제 화면으로 문서화됐다. 세 family 전체의 cohesive Modeling journey와 home-to-card acceptance는 아직 남아 있다. | `partial` | hierarchy seed retained | verifier retained | current Dashboard/Database captures; Modeling replacement pending | T-75/T-76 browser evidence, full journey pending | `FR-UX-001~009`, `T-60/T-65/T-75/T-76/T-82/T-83` |

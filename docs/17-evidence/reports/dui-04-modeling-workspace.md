...
`docs/17-evidence/capture-scripts/capture_dui04_modeling.mjs` obtains the local demo identity, opens
an exact DP780 Test Data
...
1920×1080 under `docs/17-evidence/images/ux-redesign-v2/dui-04-modeling-*.png`. Every PNG has the exact

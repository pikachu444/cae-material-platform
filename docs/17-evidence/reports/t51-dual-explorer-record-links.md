...
- `t51-catalog-workflow-explorer.jpg`: lazy tree, exact workflow nodes and forward link.
- `t51-reverse-record-link.jpg`: reverse traversal from the test record to the material revision.

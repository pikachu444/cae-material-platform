...
- Before: `docs/17-evidence/images/ux-layout-review/rejected-materials-1440x900.png` and the legacy
  database/modeling routes required the user to infer where the solver card lived.
- Approved structure: `docs/17-evidence/images/ux-layout-review/detail-1440x900.jpg` and
  `docs/17-evidence/images/ux-layout-review/card-1440x900.jpg`.
- Live after: `docs/17-evidence/images/desktop-engineering-ui/dui-02/material-datasheet-1440x900.png` and
  `docs/17-evidence/images/ux-redesign-v2/material-detail-evidence-1440x900.png`.

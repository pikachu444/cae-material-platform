...
- Before: `docs/17-evidence/images/ux-layout-review/rejected-materials-1440x900.png` — Tree was not an
  integrated navigator and the page used accumulated panels.
- Approved structural target: `docs/17-evidence/images/ux-layout-review/materials-1366x768.jpg`.
- Live after: `docs/17-evidence/images/ux-redesign-v2/materials-browse-tree-1366x768.png`.

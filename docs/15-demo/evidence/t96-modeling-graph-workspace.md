...
- Before: `docs/15-demo/images/ux-layout-review/rejected-modeling-1440x900.png`; the reviewed layout
  used a permanent three-column workspace and a 743 px graph.
- Approved prototype: `docs/15-demo/images/ux-layout-review/modeling-1440x900.png`.
- Live after: `docs/15-demo/images/ux-redesign-v2/modeling-fit-1366x768.png` and
  `docs/15-demo/images/ux-redesign-v2/modeling-fit-1440x900.png`.

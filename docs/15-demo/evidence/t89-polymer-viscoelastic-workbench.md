...
![DMA storage/loss candidate workbench](../images/t89-polymer-dma-workbench.png)

![DMA-derived Abaqus card](../images/t89-polymer-dma-abaqus-card.png)

![DMA-derived OpenRadioss card](../images/t89-polymer-dma-openradioss-card.png)

Multi-temperature relaxation and the relaxation-derived card path are recorded separately:

![WLF shift evidence and master curve](../images/t89-polymer-master-curve.png)

![Relaxation-derived Abaqus card](../images/t89-polymer-abaqus-card.png)

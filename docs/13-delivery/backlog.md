...
- 순서 12 `#189 lazy chunk 예산과 Workbench 분할 기준`은
  ...
  [PR #242](https://github.com/pikachu444/cae-material-platform/pull/242)에서 구현·검증 중이며,
  병합 뒤 다음 첫 미완료 단위는 순서 24 `#212`입니다.
...
| 23 | [#208 Definition Bundle Administration UI](https://github.com/pikachu444/cae-material-platform/issues/208) — [PR #242](https://github.com/pikachu444/cae-material-platform/pull/242) | 관리자가 upload → plan → apply → read-back/export를 안전하게 수행 | issue, #184, #204/#207, Administration 승인 화면과 권한 | stale/conflict/recovery, 역할·browser·다섯 viewport 검증 완료. 제품 소유자 피드백 반영본의 독립 Balanced 재감수와 시각 승인, merge 뒤 다음 단위는 #212 |

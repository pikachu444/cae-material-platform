...
| 8 | [#158 Modeling Fit 작업 3A — 공학 검증 계약과 reference set](https://github.com/pikachu444/cae-material-platform/issues/158) | 네 금속 hardening 공개식과 독립 reference 값·식별성·검증 경계를 후속 구현이 재현할 수 있음 | issue의 작업 3A, fitting validation, synthetic fixture/manifest, production hardening 식과 관련 test | Altair 2025 식 계약, 독립 stress/tangent/objective/recovery·tamper gate, provenance digest, reviewer 승인, merge |

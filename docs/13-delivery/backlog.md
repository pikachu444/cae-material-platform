...
- 순서 12 `#189 lazy chunk 예산과 Workbench 분할 기준`은
  ...
  `agent/issue-184-high-dpi-global-implementation`의 [Draft PR #231](https://github.com/pikachu444/cae-material-platform/pull/231)에서
  production 이식과 증거 검증을 진행 중입니다.

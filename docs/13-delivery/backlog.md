...
- 순서 12 `#189 lazy chunk 예산과 Workbench 분할 기준`은
  ...
  `ca7c97869522e3fe5d889fdc5f834bd963f85340`에서 완료했습니다. 현재 첫 미완료 단위는 순서 16
  `#221`이며 [draft PR #228](https://github.com/pikachu444/cae-material-platform/pull/228)의
  [decision packet](../17-evidence/issue-221-high-dpi-decision.md)에 대한 제품 소유자 결정이 남아 있습니다.
  `#221 → #184`를 건너뛰어 새 확장 구현을 시작하지 않습니다.
...
| 16 | [#221 4K·고DPI 레이아웃·밀도 결정 게이트](https://github.com/pikachu444/cae-material-platform/issues/221) — [draft PR #228](https://github.com/pikachu444/cae-material-platform/pull/228), **active, Product Owner decision pending** | 다섯 viewport에서 대표 후보를 비교해 구현용 잠정 layout·pane·density·table·plot 정책을 승인 | issue, #161 결과, [고해상도 전략](../12-roadmap/high-dpi-display-strategy.md), [decision packet](../17-evidence/issue-221-high-dpi-decision.md)의 원본/crop과 review prompt | P1/P2/P3 비교와 Codex P2/Standard 권고는 기록됨. 제품 소유자 disposition, draft PR 검토와 merge 전에는 완료 아님; #184 시작 금지 |
...
| 24 | [#208 Definition Bundle Administration UI](https://github.com/pikachu444/cae-material-platform/issues/208) | 관리자가 upload → plan → apply → read-back/export를 안전하게 수행 | issue, #184, #204/#207, Administration 승인 화면과 권한 | stale/conflict/recovery, 역할·browser·다섯 viewport 검증, merge |
...
| 28 | [#214 LS-DYNA MAT_024·다중 단위·Template UI](https://github.com/pikachu444/cae-material-platform/issues/214) | released Template로 MAT_024와 여러 Unit Profile 카드를 생성·관리 | issue, #160/#184/#205/#213, solver mapping/Administration | golden·unit·review·preview/download checksum·다섯 viewport·기존 solver 회귀, merge |
| 29 | [#215 SPA OIDC Code+PKCE](https://github.com/pikachu444/cae-material-platform/issues/215) | production SPA login·logout·expiry/권한 오류를 안전하게 복구 | issue, #160/#184, identity/security 계약과 deployment config | provider·negative·role·production bypass E2E·다섯 viewport, merge |

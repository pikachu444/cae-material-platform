...
- 순서 12 `#189 lazy chunk 예산과 Workbench 분할 기준`은
  ...
  `#221`이며 [decision packet](../17-evidence/issue-221-high-dpi-decision.md)의 제품 소유자 결정이
  남아 있습니다. `#221 → #184`를 건너뛰어 새 확장 구현을 시작하지 않습니다.

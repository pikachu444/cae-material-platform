...
- 순서 12 `#189 lazy chunk 예산과 Workbench 분할 기준`은
  ...
  구현·검증·독립 감수와 2026-08-28 제품 소유자 화면 승인을 완료했습니다. 다음 실행 단위는
  [#343](https://github.com/pikachu444/cae-material-platform/issues/343) Task 2B [PR #356](https://github.com/pikachu444/cae-material-platform/pull/356)이며, 이어
  [#344](https://github.com/pikachu444/cae-material-platform/issues/344) Task 3+4에서 후속 소유권과
  보류 결정을 닫습니다. #246의 네 native 자식이 모두 끝난 뒤 다음 제품 단위를 확정합니다.
...
| 26 | [#246 source-v2 원본 정합과 누락 범위 폐쇄](https://github.com/pikachu444/cae-material-platform/issues/246) — Task 1A [PR #250](https://github.com/pikachu444/cae-material-platform/pull/250), main `b9a82e96532fe796aaf1889387cd391c952e1c67`; Task 2 [#341](https://github.com/pikachu444/cae-material-platform/issues/341), [PR #345](https://github.com/pikachu444/cae-material-platform/pull/345), main `c52eaf29b63b45669eeef7b33af8cf91279b4fbc`; Task 1B [#342](https://github.com/pikachu444/cae-material-platform/issues/342), [PR #353](https://github.com/pikachu444/cae-material-platform/pull/353), main `fa4e451f5000f4610b817e490e5b7e133892a5a9`; Task 2B [#343](https://github.com/pikachu444/cae-material-platform/issues/343), [PR #356](https://github.com/pikachu444/cae-material-platform/pull/356); Task 3+4 [#344](https://github.com/pikachu444/cae-material-platform/issues/344) | 원본 포맷을 실제로 수용하고 완료 Issue 밖에 남은 요구를 중복 없이 폐쇄 | issue, 원본 패키지, 요구사항 추적표, #204~#216 현재 코드·계약 | Task 1A source adapter와 Task 2 common-unit `1.1.0`을 완료했다. Task 1B는 15개 exact JSON의 원자 등록·provenance·승인된 직접 연결 5종·publication visibility·JSON/CSV download·legacy import 회귀, Full 독립 감수와 2026-08-28 제품 소유자 화면 승인을 통과했다. #343은 frequency-temperature DMA 지원, strain sweep 미지원과 #195 production 점탄성 소유권을 문서로 확정하고, #344가 모든 후속 소유권·보류 결정을 닫는다. |

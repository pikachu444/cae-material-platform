...
- 순서 12 `#189 lazy chunk 예산과 Workbench 분할 기준`은
  ...
  [#344](https://github.com/pikachu444/cae-material-platform/issues/344) Task 3+4 [PR #357](https://github.com/pikachu444/cae-material-platform/pull/357)에서 후속 소유권과
  보류 결정을 닫고 있습니다. #246 종료 뒤 다음 제품 단위는 #195입니다.
...
| 26 | [x] [#246 source-v2 원본 정합과 누락 범위 폐쇄](https://github.com/pikachu444/cae-material-platform/issues/246) — Task 1A [PR #250](https://github.com/pikachu444/cae-material-platform/pull/250), main `b9a82e96532fe796aaf1889387cd391c952e1c67`; Task 2 [#341](https://github.com/pikachu444/cae-material-platform/issues/341), [PR #345](https://github.com/pikachu444/cae-material-platform/pull/345), main `c52eaf29b63b45669eeef7b33af8cf91279b4fbc`; Task 1B [#342](https://github.com/pikachu444/cae-material-platform/issues/342), [PR #353](https://github.com/pikachu444/cae-material-platform/pull/353), main `fa4e451f5000f4610b817e490e5b7e133892a5a9`; Task 2B [#343](https://github.com/pikachu444/cae-material-platform/issues/343), [PR #356](https://github.com/pikachu444/cae-material-platform/pull/356), main `712bda0b5c8680844d53bd27cd7295dbb0e52208`; Task 3+4 [#344](https://github.com/pikachu444/cae-material-platform/issues/344), [PR #357](https://github.com/pikachu444/cae-material-platform/pull/357) | 원본 포맷을 실제로 수용하고 완료 Issue 밖에 남은 요구를 중복 없이 폐쇄 | issue, 원본 패키지, 요구사항 추적표, #204~#216 현재 코드·계약 | Task 1A source adapter, Task 2 common-unit, Task 1B exact JSON 등록, Task 2B DMA 지원 경계를 완료했다. #344 PR #357은 #211/#213~#216의 실제 잔여와 보류 결정을 확정한다. 이 문서가 병합되면 #246을 닫고 #195로 진행한다. |
| 27 | [#195 production 폴리머 점탄성 Fit](https://github.com/pikachu444/cae-material-platform/issues/195) | 기존 synthetic/reference 계산 기반 위에서 승인된 DMA/relaxation 입력, 수치 acceptance, 후보 비교·선택·저장·reload와 실제 사용자 흐름을 production 계약으로 완성 | issue와 current planning packet, #158/#209/#246, 당시 최신 API·계산·UI, 제품 scope gate | 입력 quantity/unit, 식·parameter·bounds·objective, 독립 numerical reference와 failure/recovery를 먼저 승인. API/PostgreSQL/browser/시각 검증 뒤에만 `non_production` 경계를 변경하며 #211에 의존하지 않음 |
...
| 33 | [#162 Ubuntu VM·문서 최종 검증](https://github.com/pikachu444/cae-material-platform/issues/162) | 사용자 설치 방식과 분리된 Hyper-V Ubuntu 최종 통합검증 harness에서 전체 흐름과 역할별 복구가 재현되고 현재 문서와 화면이 일치 | issue, 병합된 기능·화면, 전체 문서 목록. 이 단계에서만 임시 문서 묶음을 읽음; Windows 11 native/offline 제품 경로는 독립 #321 | Hyper-V Ubuntu VM의 깨끗한 최종 통합검증, 전체 흐름·역추적, 문서/화면 일치, 임시 자료 정리, merge. 이를 사용자 제품 설치·배포 방식으로 선언하지 않음 |
